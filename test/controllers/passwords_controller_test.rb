...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { password: @password.password, user_id: @password.user_id, username: @password.username, vendor: @password.vendor } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { password: @password.password, user_id: @password.user_id, username: @password.username, vendor: @password.vendor } }
